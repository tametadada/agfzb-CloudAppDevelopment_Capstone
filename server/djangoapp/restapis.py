...
def get_dealer_by_id_from_cf(url, id):
    ...
    if json_result:
        # Get the row list in JSON as dealers
        dealerships = json_result["result"]
...
def analyze_review_sentiments(text):
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/107942d5-c97f-4240-ac15-4f0978b25612"
    api_key = "InYM5BIctIVReUEDZSMEFsyKyiobUtlotoo8fE0Elqi4"
